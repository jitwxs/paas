...
INSERT INTO `sys_image` VALUES ('11e97a806e274d2e89393a7e30c37a8a', '5e37cf2a267d1359ba23f3a5d81fe7b354e845a79d1cef800223235fafbaf68b', 'vimagick/iptables:latest', 'iptables', 'latest', '8789493', 1, NULL, NULL, '8789493', 'null', '[\"/bin/sh\",\"-c\",\"#(nop) \",\"CMD [\\\"/bin/sh\\\" \\\"-c\\\" \\\"iptables -F     && iptables -A INPUT -p tcp -m state --state NEW --dport $LIMIT_PORT -m connlimit --connlimit-above $LIMIT_CONN -j DROP     && iptables -A OUTPUT -p tcp -m state --state NEW -m multiport ! --dports $TCP_PORTS -j DROP     && iptables -A OUTPUT -p udp -m state --state NEW -m multiport ! --dports $UDP_PORTS -j DROP     && tc qdisc add dev eth0 root tbf rate $RATE burst $BURST latency $LATENCY     && watch -n $INTERVAL tc -s qdisc ls dev eth0\\\"]\"]', 'vimagick', '', '2018-07-17 11:11:27', NULL);
...
INSERT INTO `sys_image` VALUES ('bf822db667724f6fb839898c8c0a3edc', '350ab3987e640175267f58ba34a9e709e38d92443ba0b2c1b91a4d3d2e29681e', 'vimagick/mpd:latest', 'mpd', 'latest', '108880597', 1, NULL, NULL, '108880597', 'null', '[\"/bin/sh\",\"-c\",\"#(nop) \",\"CMD [\\\"mpd\\\" \\\"--stdout\\\" \\\"--no-daemon\\\"]\"]', 'vimagick', '', '2018-07-17 14:04:20', NULL);
...
INSERT INTO `sys_image` VALUES ('f7b5b0f3d1894439b526a44978fd62f5', 'c8b665fafb2c4955b599425ae34e5fbf4bfcd2f485ea04b617b6f4ec9a97915d', '192.168.100.94:5000/f4f4bb152cf54fec94eb0d2b22d25f71/my-busybox:latest', 'f4f4bb152cf54fec94eb0d2b22d25f71/my-busybox', 'latest', '1363351', 1, NULL, NULL, '1363351', 'null', 'null', '192.168.100.94:5000', '', '2018-07-17 11:27:19', NULL);
INSERT INTO `sys_image` VALUES ('f8df400ec07a4fe3b77e3e7c1cb2328a', '0706462ea9541c28a078f63b1d7f27407e824ae551b4de37d7f2461f4c115ff7', 'wouterm/helloworld:latest', 'helloworld', 'latest', '17788231', 1, NULL, NULL, '17788231', '{}', '[\"/bin/sh\",\"-c\",\"#(nop) \",\"ENV MSG=You have not entered a custom message\"]', 'wouterm', '', '2018-07-17 10:14:43', NULL);
...
INSERT INTO `sys_login` VALUES ('213yuyjgdqweyyj', 'wxs', '$2a$10$ip/m/nYFDXM70j2Ky4wWZu9FdmT6RPy1cg7IO/h4rkOSqV7JFYmUa', NULL, 0, 1, '2018-07-14 17:07:35', '2018-07-17 18:09:23');
INSERT INTO `sys_login` VALUES ('3241tfsegvsds', 'aaa', '$2a$10$3zdHQxZ3WkN8efEwdFZyNuVKpu14SQ3077Y2rD7HyAJpelObSpNum', NULL, 0, 1, '2018-07-17 17:15:32', '2018-07-17 18:09:23');
...
-- ----------------------------
INSERT INTO `sys_network` VALUES ('67cd22961f30674c53b6ada1cc54b9289e313572fef129686976c7e863518725', 'bridge', 'local', 'bridge', 0, 0, '{}', 1, NULL, '2018-07-17 09:29:15', NULL);
...
CREATE TABLE `sys_program`  (
  ...
  `update_date` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统服务表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_program` VALUES (18, 'afaf', NULL, NULL, NULL, '2018-07-16 21:28:05', NULL);
INSERT INTO `sys_program` VALUES (19, 'aaBAB', NULL, NULL, NULL, '2018-07-16 21:28:07', NULL);
INSERT INTO `sys_program` VALUES (20, 'AFAFA', NULL, NULL, NULL, '2018-07-16 21:28:09', NULL);
...
-- ----------------------------
INSERT INTO `user_container` VALUES ('1227edf27a196bd92dda61dddc7f6fa00b122e8dfe21199ed7bc5ab68f551965', '33398ea14de14d979a495a3a53051b1a', 'websocket', NULL, '{\"80\":[{\"HostIp\":\"0.0.0.0\",\"HostPort\":\"15889\"}]}', 'nginx:latest', 1, '2018-07-16 11:16:49', '2018-07-17 08:42:43', NULL);
...
INSERT INTO `user_container` VALUES ('1ac362d6ae6d85a4c829de2bdf4f041635ca0b7ca71d9795e3a3e43c46f9ca88', '58d227494a6c4625aa5d15495ae17156', 'wshishidhiofewaf', NULL, '{}', 'hello-world:latest', 0, '2018-07-16 19:46:31', NULL, NULL);
INSERT INTO `user_container` VALUES ('2076ac80bbdf65928df846c864c1c443a74dcd926c4bc9cb57aa237693aa4f31', '33398ea14de14d979a495a3a53051b1a', 'aegwrhg', NULL, '{\"80\":[{\"HostIp\":\"0.0.0.0\",\"HostPort\":\"15995\"}]}', 'nginx:latest', 1, '2018-07-16 19:51:52', '2018-07-17 10:02:47', NULL);
INSERT INTO `user_container` VALUES ('28b89f5b8dd6d08d28b71224de66cd09898cbace2eb2da8c691827d503908cd6', '33398ea14de14d979a495a3a53051b1a', 'wxstest', NULL, '{\"80\":[{\"HostIp\":\"0.0.0.0\",\"HostPort\":\"15668\"}]}', 'nginx:latest', 1, '2018-07-16 14:19:48', '2018-07-17 10:03:03', NULL);
...
INSERT INTO `user_container` VALUES ('dbd90eb8df97df4801778a713de084c69fbd8d181a29caa395e346727acae6f5', '758a7c9dcebd4e41b2de118356695dba', 'testpasshub7-17-11.28', NULL, '{\"80\":[{\"HostIp\":\"0.0.0.0\",\"HostPort\":\"15843\"}]}', 'nginx:latest', 0, '2018-07-17 11:29:20', NULL, NULL);
...
INSERT INTO `user_service` VALUES ('oiv0fz9pxecic281vfrdj43qu', '7570bbe140c34a328e6d5c08a66675cc', 'asdgf', 'afafaf24131', 2, '[ls, ls]', '{\"8899\":15983}', 'hello-world:latest', '[111, 222]', '2018-07-17 15:09:07', NULL);
